...
import net.raylirov.coolarmor.datagen.generators.*;
...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new ModLanguageGenerator(packOutput,  "en_us"));
        generator.addProvider(event.includeClient(), new ModLanguageGenerator(packOutput,  "ru_ru"));
        generator.addProvider(event.includeServer(), new ModRecipeGenerator(packOutput));
        generator.addProvider(event.includeServer(), new ModItemModelGenerator(packOutput, existingFileHelper));
